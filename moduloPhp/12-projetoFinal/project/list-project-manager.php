...
$createProjectPageLink = "create-project.php";
$deleteProjectPageLink = "delete-project.php";

require_once __DIR__ . '/../includes/header.php';
?>

<div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="page-header mb-0">Gerenciador de Projetos</h2>
    <a href="/projeto-final/project/create-project.php" class="btn btn-dark">
        <i class="bi bi-plus-lg me-1"></i>Adicionar Projetos</a>
</div>

<?php if ($flash): ?>
    <div class="alert alert-<?= $flash['type'] ?> alert-dismissible fade show" role="alert">
        <i class="bi bi-<?= $flash['type'] === 'success' ? 'check-circle' : 'exclamation-triangule' ?> me-2"></i>
