...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h2 class="page-header mb-0">Gerenciador de Notícias</h2>
    <a href="<?= $createNewsPageLink ?>" class="btn btn-dark"><i class="bi bi-plus-lg me-1"></i>Adicionar</a>
</div>
...
<?php if (empty($newsList)): ?>
    ...
    <div class="card form-card">
        <div class="empty-state">
            ...
            <a href="<?= $createNewsPageLink ?>" class="btn btn-dark">Adicionar</a>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-outline-danger btn-sm flex-fill" data-bs-toggle="modal"
                            ...
                            data-name="<?= htmlspecialchars($news['titulo']) ?>" data-action="<?= $deleteNewsPageLink ?>">
